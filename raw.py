def get_blosum62_dictionary():
    #generates a dictionary containing the blossum62 scores
    #keys:   string of length 2 containing a pair of amino acid codes in either order
    #raw data from https://www.ncbi.nlm.nih.gov/Class/FieldGuide/BLOSUM62.txt
    ...
    blosum62 = {}
    #load every pairwise combination in both directions as a key to the blosum62 dictionary
